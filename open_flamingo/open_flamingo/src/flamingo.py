...
class Flamingo(nn.Module):
    ...
    def wrap_fsdp(self, wrapper_kwargs, device_id, unfreeze_all):
        """
        ...
        with enable_wrap(wrapper_cls=FSDP, **wrapper_kwargs):
            ...
            # self.lang_encoder.set_input_embeddings(                        #############yongqi comment out
        ...
        if not unfreeze_all: ###yongqi add if for training original decoder layers
            for block in self.lang_encoder.old_decoder_blocks:
        ...
        def clip_grad_norm_(max_norm):
            ...
            for layer in self.lang_encoder.old_decoder_blocks: #####yongqi add
                if layer is not None:
                    layer.clip_grad_norm_(max_norm) 
            self.vision_encoder.clip_grad_norm_(max_norm) #####yongqi add
