...
def create_model_and_transforms(
    ...
    **model_kwargs,
    ...
    #     cache_dir=cache_dir,
    # )
    vision_encoder, _, image_processor = open_clip.create_model_and_transforms( ########for dropout version
        clip_vision_encoder_path,
        pretrained=clip_vision_encoder_pretrained,
        cache_dir=cache_dir,
    ...
    #     cache_dir=cache_dir,
    # )
    lang_model = AutoModelForCausalLM.from_pretrained(               ########for dropout version
        lang_model_path,
        local_files_only=use_local_files,
        trust_remote_code=True,
        cache_dir=cache_dir,
    ...
    # if text_tokenizer.pad_token is None:                                          ############yongqi add new pad token rather than eos_token is to alligh with the original openflamingo pretrain weight
